...
export const CreditCardVisual = ({ card }) => {
  if (!card) {
    return (
      <div className="card-glow p-4 sm:p-5 min-h-[9rem] sm:h-44 flex flex-col justify-between bg-gradient-to-br from-[#3C3D37]/50 via-[#2A2E24]/50 to-[#181C14] border border-[#3C3D37] relative overflow-hidden">
  ...
  return (
    <div className="card-glow p-4 sm:p-5 min-h-[10rem] sm:h-44 flex flex-col justify-between bg-gradient-to-br from-[#3C3D37] via-[#2A2E24] to-[#181C14] border border-[#4A4B44] relative overflow-hidden group">
      {/* Top Card Bar */}
